...
namespace ApiCatalogoJogo.Controllers.VT
{
    ...
    public class CicloDeVidaIDController : ControllerBase
    {
        ...
        public Task<string> Get()
        {
            ...
            stringBuilder.AppendLine($"Singleton 1: {_exemploScoped1.Id}");
            stringBuilder.AppendLine($"Singleton 2: {_exemploScoped2.Id}");
            stringBuilder.AppendLine();
            stringBuilder.AppendLine($"Scoped 1: {_exemploScoped1.Id}");
            stringBuilder.AppendLine($"Scoped 1: {_exemploScoped2.Id}");
            stringBuilder.AppendLine();
