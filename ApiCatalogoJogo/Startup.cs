...
using static ApiCatalogoJogo.Controllers.VT.CicloDeVidaIDController;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                var fileName = typeof(Startup).GetTypeInfo().Assembly.GetName() + ".xml";
